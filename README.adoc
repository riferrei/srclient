...
Using this architecture, producers programs interact with Schema Registry to retrieve schemas and use it to serialize records, and then image:images/Gopher_Dropping_Mic.png[Gopher,150,150,role="left"]consumer programs can retrieve the same schema from Schema Registry to deserialize the records.
...
image::images/Locating_Managed_Schema_Registry.png[]
...
image::images/Getting_Endpoint_and_APIKeys.png[]
