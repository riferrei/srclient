...
func (x *HelloRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloRecord) ProtoMessage() {}

func (x *HelloRecord) ProtoReflect() protoreflect.Message {
	mi := &file_proto_hello_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloRecord.ProtoReflect.Descriptor instead.
func (*HelloRecord) Descriptor() ([]byte, []int) {
	return file_proto_hello_proto_rawDescGZIP(), []int{1}
}

func (x *HelloRecord) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *HelloRecord) GetTime() *Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x20, 0x73, 0x72, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x65, 0x78,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x3b, 0x0a, 0x09, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	...
	0x6f, 0x73, 0x22, 0x62, 0x0a, 0x0b, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x63, 0x6f, 0x72,
	...
	0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x73, 0x72, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x65,
	0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x52, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x72, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x65, 0x78,
...
var file_proto_hello_proto_goTypes = []interface{}{
	(*Timestamp)(nil),   // 0: srclient.examples.protobuf.hello.Timestamp
	(*HelloRecord)(nil), // 1: srclient.examples.protobuf.hello.HelloRecord
}
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: srclient.examples.protobuf.hello.HelloRecord.time:type_name -> srclient.examples.protobuf.hello.Timestamp
